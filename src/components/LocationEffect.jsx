...
const LocationEffect = () => {
  ...
  return (
    <div className="w-scree h-screen bg-[#626262] flex flex-col justify-center items-center">
        <label className="text-[#EEEEEE] mb-2" htmlFor="text">Insert your name:</label>
      <input className="mt-1 rounded-lg" onChange={(event) => setName(event.target.value)} type="text" />
      <br />
